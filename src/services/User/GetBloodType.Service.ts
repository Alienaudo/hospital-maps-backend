...
export class GetBloodTypeService {
    ...
    public exec = async (
        ...
        try {
            ...
            const result: { bloodType: BloodType } = await this.prisma.user
                .findUniqueOrThrow({
            ...
            logger.error(`Erro while getting user's blood type: ${error}`);
